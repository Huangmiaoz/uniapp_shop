	...
	export default {
		...
		methods: {
			...
			preview(i) {
				...
				console.log('this.goods_info.pics',this.goods_info.pics)
				uni.previewImage({
					// 预览时，默认显示图片的索引
					current: i,
					// 所有图片 url 地址的数组
			...
			buttonClick(e) {
				...
				// console.log('buttonClick',e.content)
				// console.log('buttonClick',e.content.text)
				// 1. 判断是否点击了 加入购物车 按钮
